...
Public Class frmPasaTiem
    ...
    Public Sub CargarDatos()
        ...
        rptDatos.DataBind()
        Dim obj As New PasatiempoBL(cadena)
    ...
    Protected Sub rptDatos_ItemCommand(source As Object, e As RepeaterCommandEventArgs)
        ...
        Dim idPas As New Pasatiempo()
        idPas.IdPasatiempo = id
        Dim obj As New PasatiempoBL(cadena)
        If e.CommandName = "editacion" Then
            idPas = obj.Obtener(idPas)
            hfIdAccion.Value = id
            txtDescripcion.Text = idPas.Descripcion
    ...
    Protected Sub btnGuardar_Click(sender As Object, e As EventArgs)
        ...
        If txtDescripcion.Text.Trim() <> String.Empty Then
            Dim idPas As New Pasatiempo()
            Dim obj As New PasatiempoBL(cadena)
            idPas.Descripcion = txtDescripcion.Text.Trim()
            ...
            Else
                'modificacion
                idPas.IdPasatiempo = hfIdAccion.Value
                obj.Actualizar(idPas)
                valida = True
            End If
            If Not obj.HayError Then
    ...
    Private Sub frmPasaTiem_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
        Acceso(7)
    End Sub
End Class