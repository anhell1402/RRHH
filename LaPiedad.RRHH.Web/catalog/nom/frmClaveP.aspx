<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="frmClaveP.aspx.vb" Inherits="LaPiedad.RRHH.Web.frmClaveP" %>
                              ...
                              <div class="row">
                                ...
                                <div class="col-8">
                                  <asp:DropDownList  ID="ddlTipoPago" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="1">Persepción</asp:ListItem>
                                    <asp:ListItem Value="2">Deducción</asp:ListItem>
                                  </asp:DropDownList>
                                </div>
                            </div>
                        </div>
